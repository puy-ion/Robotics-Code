...
task usercontrol()
{
	...
	SensorValue[left] = 0;
	SensorValue[right] = 0;
	while(SensorValue[left]<1100 && SensorValue[right]<1100){
		motor[port1] = 127;
		motor[port2] = -127;
		motor[port3] = -127;
		motor[port5] = 127;
	...
	SensorValue[left] = 0;
	SensorValue[right] = 0;
	while(SensorValue[left]>-550 && SensorValue[right]>-550){
		motor[port1] = -127;
		motor[port2] = 127;
		motor[port3] = 127;
		motor[port5] = -127;
	...
	while(1==1){
		//DRIVING///////////////////////////////////////////////////////////////////
	bool limited = (vexRT[Btn5U] == 1);
		int a = 0.66*(-(vexRT[Ch3] + vexRT[Ch4] + vexRT[Ch3Xmtr2] + vexRT[Ch4Xmtr2]));
		int b = 0.66*(-(vexRT[Ch3]*-1 + vexRT[Ch4] + vexRT[Ch3Xmtr2]*-1 + vexRT[Ch4Xmtr2]));
